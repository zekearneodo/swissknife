...
from swissknife.bci.core.intan.util.read_header import read_header
from swissknife.bci.core.intan.util.get_bytes_per_data_block import get_bytes_per_data_block
from swissknife.bci.core.intan.util.read_one_data_block import read_one_data_block
from swissknife.bci.core.intan.util.notch_filter import notch_filter
from swissknife.bci.core.intan.util.data_to_result import data_to_result
...
def read_data(filename):
    ...
    if (data_present):
        ...
        # Do not scale voltage levels; leave as specified by the intan application data sheet.
        # http://intantech.com/files/Intan_RHD2000_data_file_formats.pdf
        data['amplifier_data'] = data['amplifier_data']
        data['aux_input_data'] = data['aux_input_data']               # units = volts
        data['supply_voltage_data'] = data['supply_voltage_data']    # units = volts

        data['board_adc_data'] = data['board_adc_data'] # units = volts

        data['temp_sensor_data'] = data['temp_sensor_data']
