...
def get_bytes_per_data_block_rhs(header):
    """Calculates the number of bytes in each 60-sample datablock."""

    # Each data block contains 128 amplifier samples.
    bytes_per_block = 128 * 4  # timestamp data
    bytes_per_block = bytes_per_block + 128 * 2 * header['num_amplifier_channels']
